...
def main():
    ...
    if not st.session_state.authenticated:
        ...
        if page == "Accueil":
            ...
            st.image(
                "https://github.com/Yas-rad/Streamlit-Partie-3-/blob/main/image%20welcome.jpg", 
            ...
            cols = st.columns(3)
            images =[
        "https://github.com/Yas-rad/Streamlit-Partie-3-/blob/main/photo%201.jpg",
        "https://github.com/Yas-rad/Streamlit-Partie-3-/blob/main/Photo%202.jpg",
        "https://github.com/Yas-rad/Streamlit-Partie-3-/blob/main/Photo%204.jpg",
    ]
